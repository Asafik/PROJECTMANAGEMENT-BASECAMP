    ...
    <div class="container px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="Page navigation example navbar-nav ms-auto mb-10 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="calendar.html"><i class="bi bi-calendar3" style="font-size:28px"></i></i></a></li>
                <li class="nav-item"><a class="nav-link" href="#!"><i class="bi bi-clock" style="font-size:28px"></i></i></a></li>
            </ul>
        </div>
