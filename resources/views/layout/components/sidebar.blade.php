...
<nav class="navbar navbar-expand-lg navbar-light bg-light">&emsp;&emsp;&nbsp;
    <div class="container px-lg-0 m-1">
        ...
        <li class="nav-item"><a class="nav-link"></a></li>
            ...
            <circle cx="11" cy="9" r="9" fill="#FEA21F"></svg>&nbsp;&nbsp;&nbsp;Project ABCD&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</a>
                    <ul class="dropdown-menu dropdown-menu-" aria-labelledby="navbarDarkDropdownMenuLink" style="width:100%">
        ...
        <ul class="navbar-nav ms-auto mb-10 mb-lg-0">
            ...
            <ul class="dropdown-menu dropdown-menu">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi-plus-square-fill"><input
                    type="text" class="form-control" placeholder="title"></input></i></a>
