...
<section class="pt-3">
    <div class="container px-lg-0">
                    ...
                    <form action="#" method="#" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="Submit" class="btn btn-success me-3"
                                style="background-color:#20B15A">Save</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="exampleModalAddDiscussion" tabindex="-1" aria-labelledby="exampleModalAddDiscussion"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="#" method="#" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="form-check form-switch col-sm-8 align-self-center">
                                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckSticky"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="form-check form-switch col-sm-8  align-self-center">
                                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckPrivate"
                                                style="height: 20px; width: 40px;">
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="Submit" class="btn btn-success me-3"
                                style="background-color:#20B15A">Create</button>
                        </div>
                    </form>
