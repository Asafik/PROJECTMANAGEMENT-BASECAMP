        ...
        <!-- Header-->
          ...
          <section class="pt-3">
            ...
            <div class="col-lg-12 mb-5 d-flex"> 
              ...
              <button class="btn btn-secondary me-3 border-0" style="background-color:#ffff" data-bs-toggle="modal" data-bs-target="#exampleModalsetting"><i class="bi bi-gear-fill" style="color: #838492;"></i></button>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-10 ms-auto">
                        <div class="col-md-4 offset-md-8 ">
                          <div class="progress-bar bg-success fs-9 fw-" role="progressbar" style="width: 60%; margin-left: 30%; margin-bottom: 10% ;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
                          <div class="progress-bar bg-warning" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
                         <div class="progress " role="progressbar" style="width: 30%; background-color:#838492; margin-top: -10%; margin-right: 10%;" aria-valuenow="30" height="5" aria-valuemin="0" aria-valuemax="100">
                        </div>
                       </div>
                      </div>
                    </div>
