    ...
    <div class="container px-lg-0">
        ...
        <a class="btn btn-secondary-outline" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
          ...
          <a class="btn btn-secondary-outline me-auto btn" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
           ...
           <button class="btn btn-success me-3" style="background-color:#20B15A" data-bs-toggle="modal" data-bs-target="#exampleModal"></i> New Folder</button>
              <button class="btn btn-success me-3" style="background-color:#20B15A" data-bs-toggle="modal" data-bs-target="#exampleModalAddtask"></i> Upload</button>
                                ...
                                <div class="col-sm-2 mx-1 mb-5">
                                    ...
                                    <div><img src="images/filedoc.svg">Analys <br> May 12</div>
                                            <div class= "desc">
                                                ...
                                                <strong><i class="filedoc.svg"></i> File</strong></i></div>
