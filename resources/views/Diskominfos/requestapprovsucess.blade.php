            ...
            <div class="col-lg-12 mb-3">
                <div class="card bg-light border-0">
                    <div class="card-body fs-6 text-sm-start p-8 p-lg-3 pt-0 pt-lg-0">
                        <div style="width:100%;" class="btn bg-primary bg-gradient rounded-3 mb-3 mt-n3 text-center text-white"><a href=""><span class="text-white"><img src="img/logorequest.svg" width="30"><strong> Request Project Approval</strong></a></i></div>
                              ...
                              <div class="d-grid gap-2">
                                {{-- <div class="btn-secondary mb-3"><a href="/homediskominfos"><span class="text-white"><strong>Successfully  Accepment Request Project</strong></a></i></div> --}}
                                  <button class="btn btn-success btn me-2"><a href="/homediskominfos"><span class="text-white"><strong>Successfully  Accepment Request Project</strong></a></i></button>
                              </div>
                        </div>
                        </div>
                    </div>
