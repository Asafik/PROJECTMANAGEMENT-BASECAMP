...
<section class="pt-2">
        ...
        <div class="row ">
            ...
            <div class=" me-md-2 col-lg-12 col-xxl-12 mb-5">
                <div class="card bg-light border-0 h-100 mb-5">
                    <div class="col-lg-6 mb-4 d-flex ms-4 text-center">
    ...
    <ul>
   <p class="fs-9 fw-bold text-start "><p class="" style="text-align: justify; margin-left: 1%; margin-right: 1%"><i class="bi bi-three-dots-vertical" style="margin-right:-2%;"></i><i class="bi bi-three-dots-vertical"style="margin-right: 1%"></i>{{$t->TimeWorked }}
    <mark style="background-color: #D0D9EE; color: #838492;">{{$t->Status}}</mark><button type="button"
        class="btn btn-warning btn-sm" style="margin-left: 1%; margin-top: 1; color: #fff; ">{{ $t->By }}</button><mark
        style="background-color: #D0D9EE;margin-left: 1%; color: #838492;">due </mark><mark
        style="color: #FF3D00; background-color: #D0D9EE;">may 30</mark><i class="bi bi-flag-fill btn"
        style="color : #3766DF"></i><a class="bi bi-chat-left btn" href="discussopd.html"
    ...
    <div class="modal fade" id="exampleModalEditRecordFull" tabindex="-1" aria-labelledby="exampleModalEditRecordFull"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <<<<<<< HEAD:resources/views/OpdReqProject/time_board.blade.php <form action="#" method="#"
                            ...
                            <div class="d-flex col-lg-6 mb-3">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    >>>>>>>
                                    86aaec0a03fbaccbbf4354a79b2e9e4326f6dc9a:resources/views/Project/time_board.blade.php
                                </div>
                                <div class="d-flex col-lg-6 mb-3">
                                    <label for="inputEmail4" class="form-label col-lg-5">Doing</label>
                                    <textarea type="text" id="appt" name="appt" class="form-control col-lg-6"
