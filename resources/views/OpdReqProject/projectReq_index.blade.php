                ...
                <div class="row gx-lg-5">
                    <div class="col-lg-4 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                ...
                                <a href="/projectReq_all" style="color: #838492">
                                    <p class="text-center">More project request</p>
                                </a>
                                @endforeach
                    ...
                    <div class="col-lg-4 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            ...
                            <p class="fs-9 fw-bold text-start"><img src="images/icon2.svg" style="width: 6%; margin-right : 5%;">Mentioned</p><img src="images/line.svg" style="width: 112%; margin-top:-10%;margin-left: -6%">
