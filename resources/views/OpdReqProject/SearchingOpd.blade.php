    ...
    <section class="pt-2">
        <div class="container ">
            <div class="modal fade" id="SearchOpd" tabindex="-1" aria-labelledby="SearchOpd" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="SearchOpd">Search</h5> <i class="bi bi-search ms-1"
